...
- **Full Clean Architecture split** (domain / use cases / adapters /
  infrastructure) — deliberate portfolio showcase; the lighter 3-layer split
  would suffice for this size otherwise.
...
- **Static coverage badge (shields.io) instead of Codecov** — no external
  service or token for a portfolio project; the number is updated manually
